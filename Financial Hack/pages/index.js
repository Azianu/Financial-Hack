...
export default function Home({transactions, rawFileContents}) {
    ...
    return (
        <div className="container">
            <Head>
                <title>MLH FINANCIAL HACK</title>
            ...
            <main>
                <header>
                    <h1>
                        <span className="header-title-yellow">Paw</span>
                        <span className="header-title-red">League</span>
                        <span className="header-title-blue">Banking</span>
                    </h1>
                </header>
